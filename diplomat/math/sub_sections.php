...
<body>
    ...
    <div class="container">
        <div class="pricing-header px-3 py-3 pt-md-5 pb-md-4 mx-auto text-center">
            ...
            <h4>Procesos de aprendizaje y enseñanza de las matemáticas </h4>
            <p class="lead">Podrás consultar el programa, así como el contenido de la misma además de poder descargar
                las actividades.</p>
            <hr>
        </div>
        <div class="card-deck mb-3 text-center">
            <div class="card box shadow mb-4 text-white" style=" background-color:#00BFFF;">
                <div class="card-header">
                    <h4 class="card-title">Evidencia</h4>
                </div>
                <div class="card-body">
                    <p class="lead">Descarga docs. y fotos</p>
                    <a href="../evidence_docs/sub_sections.php" class="btn btn-section-1">Acceder</a>
                </div>
            </div>
